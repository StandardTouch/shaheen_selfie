...
class WithbgPreview extends ConsumerStatefulWidget {
  const WithbgPreview({super.key, required this.imagePath});
  final String imagePath;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _WithbgPreviewState();
}

class _WithbgPreviewState extends ConsumerState<WithbgPreview> {
